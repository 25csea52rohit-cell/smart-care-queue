...
import { Siren, Baby, Stethoscope, HeartPulse, Brain, Activity } from 'lucide-react';
  ...
  return (
    <section id="departments" className="py-20 bg-white dark:bg-slate-900 border-b border-slate-200/80 dark:border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* 6 Department Cards Grid (Exact Layout from Image) */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {departments.map((dept, idx) => (
            <motion.div
              ...
              className="dept-card p-6 rounded-3xl flex items-center gap-5 cursor-pointer"
            >
              <div className="p-4 rounded-2xl bg-sky-50 dark:bg-slate-800/80 shrink-0">
                {dept.icon}
              </div>
