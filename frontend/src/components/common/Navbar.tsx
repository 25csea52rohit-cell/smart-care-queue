      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-semibold text-slate-600 dark:text-slate-300">
            ...
            <a href="#departments" className="hover:text-sky-600 dark:hover:text-sky-400 transition">
              Find Doctor
            </a>
            <a href="#features" className="hover:text-sky-600 dark:hover:text-sky-400 transition">
              Features
            </a>
            <a href="#faq" className="hover:text-sky-600 dark:hover:text-sky-400 transition">
              Contact
            </a>
          </nav>
